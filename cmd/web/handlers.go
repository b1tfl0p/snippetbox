...
import (
	...
	"github.com/b1tfl0p/snippetbox/internal/models"
	"github.com/b1tfl0p/snippetbox/internal/validator"
...
func (app *application) about(w http.ResponseWriter, r *http.Request) {
	data := app.newTemplateData(r)
	app.render(w, http.StatusOK, "about.gotmpl", data)
}
...
func (app *application) accountPasswordUpdate(w http.ResponseWriter, r *http.Request) {
	...
	app.render(w, http.StatusOK, "password.gotmpl", data)
}
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		...
		app.render(w, http.StatusUnprocessableEntity, "password.gotmpl", data)
		return
	}
