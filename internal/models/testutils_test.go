...
func newTestDB(t *testing.T) *sql.DB {
	...
	// setup and teardown scripts contains multiple SQL statements, we need to
	// use the "multiStatements=true" parameter in our DSN. This instructs our
	...
	// Read the setup SQL script from file and execute the statement.
